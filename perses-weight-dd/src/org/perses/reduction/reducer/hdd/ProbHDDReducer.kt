...
import org.perses.delta.WeightedDeltaDebugger
...
//        ),
//      )
      val debugger = PristineProbabilisticDeltaDebugger(
        createDeltaArguments(
          needToTestEmpty = true,
          tree,
          actionsDescription = "[pristine-ProbDD]",
          input = currentLevel,
        ),
      ) { it.leafTokenCount }
