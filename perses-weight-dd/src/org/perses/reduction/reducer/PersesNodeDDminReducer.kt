...
object PersesNodeDDminReducer {
  const val NAME = "perses_ddmin"

  val META: ReducerAnnotation = object : ReducerAnnotation(
    shortName = "perses_ddmin",
    description = "ddmin-based perses node reducer",
    deterministic = true,
      ...
      ImmutableList.of<AbstractTokenReducer>(
        PersesNodeReducer(
          ...
          deltaDebuggerStrategy = { args ->
            PristineDeltaDebugger(args) {it.leafTokenCount}
          },
        ),
      )
  }
