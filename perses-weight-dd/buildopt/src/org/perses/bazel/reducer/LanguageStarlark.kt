...
object LanguageStarlark : LanguageKind(
  name = "starlark",
  // The extension is broken here because BUILD files can have no extensions.
  // We might need to use regexp.
  extensions = ImmutableSet.of("BUILD"),
