...
class NameExprAst(val id: Identifier) : AbstractPythonExprAst() {

  override val precedence: IPrecedence
    get() = Precedence.UNIT

  override fun toSourceCode(stream: PrintStream, indent: Indent, multiLineMode: Boolean) {
    stream.print(id.value)
  }
}

fun CharSequence.toNameExprAst() = NameExprAst(toIdentifier())
fun Identifier.toNameExprAst() = NameExprAst(this)
