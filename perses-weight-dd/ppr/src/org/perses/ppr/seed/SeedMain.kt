...
class SeedMain(args: Array<String>) : AbstractMain<SeedCmdOptions, SeedReductionDriver>(args) {
  ...
  override fun createReductionDriver(
    ...
    return SeedReductionDriver.create(cmd, facadeFactory, ImmutableList.of())
  }
