...
class ListDiffMain(args: Array<String>) :
  AbstractMain<ListDiffCmdOptions, ListDiffReductionDriver>(args) {
  ...
  override fun createReductionDriver(
    ...
    return ListDiffReductionDriver.create(cmd, facadeFactory)
  }
